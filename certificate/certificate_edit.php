...
$stmt = $pdo->prepare("SELECT * FROM certificate WHERE id = ?");
$stmt->execute(array($id));
$certificate = $stmt->fetch();

$name = $certificate['name'];
$level = $certificate['level'];
$fed = $certificate['id_federation'];
...
?>
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <button class="btn btn-outline-warning" type="submit" name="submit">Certificatie wijzigen</button>
        </form>
    </div>
<?php
